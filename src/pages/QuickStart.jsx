...
import ColdCarti from "../images/cold-carti.jpg";

function Button() {
    return <button className="t-lg border-2 w-fit mx-auto px-6 py-3">Я компонент кнопка</button>;
}
...
export default function App() {
    ...
    const listItems = animals.map((animals) => (
        <li
            key={animals.id}
            style={{ color: animals.pet ? "green" : "red" }}
            className="t-xl">
            {animals.title}
        </li>
    ));
            ...
            <div className="flex flex-col gap-10 my-10 max-w-5xl mx-auto justify-center px-5">
                ...
                <div className="flex flex-col gap-3 text-center">
                    ...
                    <div className="flex flex-col justify-center">
                        <a
                            href="https://music.yandex.ru/artist/6487554?utm_source=desktop&utm_medium=copy_link"
                            target="_blank"
                            rel="noreferrer"
                            className="rounded-full mx-auto">
                            <img
                                src={coldcarti.imageUrl}
                                style={{ width: coldcarti.imageSize }}
                                width={200}
                                height={200}
                                alt=""
                                className="rounded-full mx-auto"
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="text-center t-2xl font-bold">
                            {coldcarti.name}
                        </a>
                    </div>
                </div>
                <div className="flex flex-col gap-3 text-center">
                    ...
                    <a
                        ...
                        href="https://www.youtube.com/watch?v=TeFyOF1Yyrk"
                        target="_blank"
                        rel="noreferrer">
                        <img
                            width={500}
                            src={choice ? Puma : Pantera}
                            alt=""
                        />
                    </a>
                    <p className="t-2xl mx-auto">{choice ? "С пумой" : "С пантерой"}</p>
                    <button
                        onClick={() => setChoice((choice) => !choice)}
                        className="t-lg border-2 w-fit mx-auto px-6 py-3">
                        Поменять выбор
                    </button>
                </div>
                ...
                <div className="flex flex-col gap-3 text-center">
                    ...
                    <p className="t-2xl">
                        Если это домашнее животное, то отметить{" "}
                        <span className="text-green-600">зелёным</span> цветом, иначе{" "}
                        <span className="text-red-500">красным</span> цветом
                    </p>
                    <ul className="text-center border-2 p-5 px-10 w-fit mx-auto">{listItems}</ul>
                </div>
